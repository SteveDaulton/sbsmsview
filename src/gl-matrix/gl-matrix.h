 ...
 * dest if not NULL, vec otherwise
 */
vec3_t vec3_scale(vec3_t vec, T val, vec3_t dest);
 ...
 */
T vec3_dot(vec3_t vec, vec3_t vec2);
...
vec3_t vec3_lerp(vec3_t vec, vec3_t vec2, T lerp, vec3_t dest);
 ...
 */
T vec3_dist(vec3_t vec, vec3_t vec2);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotate(mat4_t mat, T angle, vec3_t axis, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateX(mat4_t mat, T angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateY(mat4_t mat, T angle, mat4_t dest);
 ...
 * dest if not NULL, mat otherwise
 */
mat4_t mat4_rotateZ(mat4_t mat, T angle, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_frustum(T left, T right, T bottom, T top, T near, T far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_perspective(T fovy, T aspect, T near, T far, mat4_t dest);
 ...
 * dest if not NULL, a new mat4_t otherwise
 */
mat4_t mat4_ortho(T left, T right, T bottom, T top, T near, T far, mat4_t dest);
 ...
 */
T quat_dot(quat_t quat, quat_t quat2);
 ...
 * dest if not NULL, quat otherwise
 */
quat_t quat_slerp(quat_t quat, quat_t quat2, T slerp, quat_t dest);
