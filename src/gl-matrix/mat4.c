...
mat4_t mat4_create(mat4_t mat) {
    mat4_t dest = calloc(sizeof(T), 16);
...
mat4_t mat4_transpose(mat4_t mat, mat4_t dest) {
    ...
    if (!dest || mat == dest) {
        T a01 = mat[1], a02 = mat[2], a03 = mat[3],
            a12 = mat[6], a13 = mat[7],
            a23 = mat[11];
...
T mat4_determinant(mat4_t mat) {
    ...
    T a00 = mat[0], a01 = mat[1], a02 = mat[2], a03 = mat[3],
...
mat3_t mat4_toInverseMat3(mat4_t mat, mat3_t dest) {
    // Cache the matrix values (makes for huge speed increases!)
    T a00 = mat[0], a01 = mat[1], a02 = mat[2],
...
mat4_t mat4_perspective(T fovy, T aspect, T near, T far, mat4_t dest) {
    T top = near * tan(fovy * M_PI / 360.0),
        right = top * aspect;
