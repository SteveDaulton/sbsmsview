...
quat_t quat_multiply(quat_t quat, quat_t quat2, quat_t dest) {
    ...
    T qax = quat[0], qay = quat[1], qaz = quat[2], qaw = quat[3],
...
quat_t quat_slerp(quat_t quat, quat_t quat2, T slerp, quat_t dest) {
    ...
    T cosHalfTheta = quat[0] * quat2[0] + quat[1] * quat2[1] + quat[2] * quat2[2] + quat[3] * quat2[3],
        halfTheta,
        sinHalfTheta,
        ratioA,
        ratioB;
